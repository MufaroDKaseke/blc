  ...
  <ul class="sidebar-nav nav flex-column">
    ...
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" href="#" id="libraryDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <span>Materials</span><i class="fa fa-angle-right"></i>
      </a>
      <div class="dropdown-menu" aria-labelledby="libraryDropdown">
        <a class="dropdown-item" href="<?php echo ROOT;?>/admin/private-materials.php">Private</a>
        <a class="dropdown-item" href="<?php echo ROOT;?>/admin/materials.php">Public</a>
      </div>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
      <a href="<?php echo ROOT;?>/admin/profile.php" class="nav-link">Profile</a>
    </li>
  </ul>
</div>
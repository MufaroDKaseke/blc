...
<head>
  ...
  <title>Babbel Language Center | B1 German</title>
  <!-- Libraries -->
...
<body>
        ...
        <div class="collapse navbar-collapse" id="headerNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu active" aria-labelledby="libraryDropdown">
                ...
                <a class="dropdown-item active" href="<?=ROOT;?>/library/B1-German.php">B1 German <span class="sr-only">(current)</span></a>
              </div>
            </li>
            <li class="nav-item">
  ...
  <section class="pageheader">
    <div class="container">
      <div class="row">
        <div class="col">
          <h1 class="pageheader-title">B1 German</h1>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-between">
          ...
          if (isset($_GET['q'])) {
            ...
            // Get the materials
            $materials = getMaterialsByCategory($conn, 'B1 German');
          }

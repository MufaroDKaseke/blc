...
<head>
  ...
  <title>Babbel Language Center | A1 German</title>
  <!-- Libraries -->
...
<body>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown active">
              ...
              <div class="dropdown-menu" aria-labelledby="libraryDropdown">
                ...
                <a class="dropdown-item active" href="<?=ROOT;?>/library/A1-German.php">A1 German <span class="sr-only">(current)</span></a>
  ...
  <section class="pageheader">
    <div class="container">
      <div class="row">
        <div class="col">
          <h1 class="pageheader-title">A1 German</h1>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-between">
          ...
          if (isset($_GET['q'])) {
            ...
            // Get the materials
            $materials = getMaterialsByCategory($conn, 'A1 German');
          }

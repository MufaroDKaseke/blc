  ...
  <div class="user-nav">
    <div class="dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="libraryDropdown">
        <a class="dropdown-item" href="<?php echo ROOT;?>/dashboard/profile.php">Profile</a>
        <a class="dropdown-item" href="<?php echo ROOT;?>/dashboard/login.php?action=logout_student"><span>Logout</span> <i class="fa fa-sign-out"></i></a>
      </div>
    </div>
  </div>
</nav>
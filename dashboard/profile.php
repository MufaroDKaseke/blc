        ...
        <div class="container-fluid">
          <div class="row">
            ...
            if (isset($_POST['action'])) {
              if ($_POST['action'] === 'update_student_profile') {

                $formData = $_POST;
                $prevData = getStudent($conn, $formData['student_id']);
                      ...
                      <form action="./profile.php" method="post">
                        <div class="form-row">
                          ...
                          <div class="col-12 form-group">
                            ...
                            <button type="action" name="action" value="update_student_profile" class="btn blc-btn btn-sm">Save</button>
                          </div>
